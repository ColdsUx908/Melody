...
public static class TOReflectionUtils
{
    ...
    public static bool HasRealMethod(this Type type, string methodName, BindingFlags bindingAttr) =>
        HasRealMethod(type, methodName, bindingAttr, out _);

    public static bool MustHaveRealMethodTogether(this Type type, string methodNameA, string methodNameB, BindingFlags bindingAttr, out MethodInfo methodInfoA, out MethodInfo methodInfoB) =>
        TOMathHelper.GetTwoBooleanStatus(type.HasRealMethod(methodNameA, bindingAttr, out methodInfoA),
                                         type.HasRealMethod(methodNameB, bindingAttr, out methodInfoB))
            is TwoBooleanStatus.Both or TwoBooleanStatus.Neither;

    public static bool MustHaveRealMethodTogether(this Type type, string methodNameA, string methodNameB, BindingFlags bindingAttr) =>
        MustHaveRealMethodTogether(type, methodNameA, methodNameB, bindingAttr, out _, out _);
