    ...
    ICollidable<Circle, RotatedRectangle>
{
    ...
    public readonly bool Collides(FloatRectangle other) => TOCollisionHelper.SingleCollision.FloatRectanglevCircleCollision(other, this);
    public readonly bool Collides(RotatedRectangle other) => TOCollisionHelper.SingleCollision.RotatedRectanglevCircleCollision(other, this);
}
