    ...
    public static class KingSlimeAI
    {
        ...
        public static bool VanillaKingSlimeAI(NPC npc, Mod mod)
        {
            ...
            if (npc.velocity.Y == 0f)
            {
                ...
                npc.velocity.X *= 0.8f;
                if (npc.velocity.X is > (float)-0.1 and < (float)0.1)
                    npc.velocity.X = 0f;
                ...
                if (!flag7)
                {
                    ...
                    if (npc.ai[0] >= 0f)
                    {
                        ...
                        {
                            npc.velocity.Y = -13f;
                            npc.velocity.X += (Main.masterMode ? 5.25f : 3.5f) * npc.direction;
                        ...
                        {
                            npc.velocity.Y = -6f;
                            npc.velocity.X += (Main.masterMode ? 6.75f : 4.5f) * npc.direction;
                        ...
                        {
                            npc.velocity.Y = -8f;
                            npc.velocity.X += (Main.masterMode ? 6f : 4f) * npc.direction;
                            npc.ai[0] = -(Main.masterMode ? 80f : 100f);
                            npc.ai[1] += 1f;
                        }
                    }
            ...
            else if (npc.target < Main.maxPlayers)
            {
                ...
                {
                    if (npc.direction == -1 && npc.velocity.X < 0.1 || npc.direction == 1 && npc.velocity.X > -0.1)
                        npc.velocity.X += (Main.masterMode ? 0.3f : 0.2f) * npc.direction;
                    else
