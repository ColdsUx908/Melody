...
public sealed class CalamityGlobalProjectileDetour : GlobalProjectileDetour<CalamityGlobalProjectile>
{
    ...
    {
        if (projectile.TryGetBehavior(out CAProjectileBehavior projectileBehavior, nameof(CAProjectileBehavior.PreAI)))
        {
    ...
    {
        if (projectile.TryGetBehavior(out CAProjectileBehavior projectileBehavior, nameof(CAProjectileBehavior.GetAlpha)))
        {
    ...
    {
        if (projectile.TryGetBehavior(out CAProjectileBehavior projectileBehavior, nameof(CAProjectileBehavior.PreDraw)))
        {
