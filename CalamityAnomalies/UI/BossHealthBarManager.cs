...
#pragma warning restore IDE0028 // Simplify collection initialization
        ...
        public class BossHPUI
        {
            ...
            public void Draw(SpriteBatch sb, int x, int y)
            {
                ...
                // BUT ANOMALY IS MORE IMPORTANT.
                Color basecolor = new Color(240, 240, 255);
                Color separatorColor = basecolor * animationCompletionRatio;
                if (CAWorld.Anomaly)
                    separatorColor = Color.Lerp(basecolor, Color.HotPink * 0.75f, EnrageTimer / (float)EnrageAnimationTime) * animationCompletionRatio;
                else if (NPCIsEnraged)
                    separatorColor = Color.Lerp(basecolor, Color.Red * 0.5f, EnrageTimer / (float)EnrageAnimationTime) * animationCompletionRatio;
                else if (NPCIsIncreasingDefenseOrDR)
                    separatorColor = Color.Lerp(basecolor, Color.LightGray * 0.5f, IncreasingDefenseOrDRTimer / (float)IncreasedDefenseOrDRAnimationTime) * animationCompletionRatio;
                ...
                if (CAWorld.Anomaly)
                {
                    ...
                    float outwardness = 1.5f + pulse * 2f;
                    Color color1 = Color.HotPink * 0.6f;
