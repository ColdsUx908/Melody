...
public static class YharimsGift_Handler
{
    ...
    public static void AddBlessingTooltip(CAItemTooltipModifier tooltipModifier) => tooltipModifier.AddCATooltip(Language.GetTextValue(LocalizationPrefix + "BlessingTooltip"), GiftColor);

    public static void AddGoldTooltip(CAItemTooltipModifier tooltipModifier, string text) => tooltipModifier.AddCATooltip(text, Color.Gold);
...
public sealed class YharimsGift_Tweak : CAItemTweak<YharimsGift>, ICATweakLocalizationPrefix
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        new CAItemTooltipModifier(Item, tooltips)
            .AddCATooltipDefault(this, YharimsGift_Handler.GiftColor, YharimsGift_Handler.BlessingName);
    }
}
