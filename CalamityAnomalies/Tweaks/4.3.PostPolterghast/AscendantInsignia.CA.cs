...
public sealed class AscendantInsignia_Tweak : CAItemTweak<AscendantInsignia>
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        {
            YharimsGift_Handler.AddBlessingTooltip(tooltipModifier);
            YharimsGift_Handler.AddGoldTooltip(tooltipModifier, this.GetTextFormat("BlessingTooltip0"));
            YharimsGift_Handler.AddGoldTooltip(tooltipModifier, this.GetTextFormat("BlessingTooltip1"));
            YharimsGift_Handler.AddGoldTooltip(tooltipModifier, this.GetTextFormat("BlessingTooltip2"));
        }
    }
}
